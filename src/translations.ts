...
export const translations: Record<string, TranslationData> = {
  en: {
    ...
    enableMultiplayer: 'Enable Multiplayer (optional)',
      ...
      directP2PDesc: 'Play with a friend without any server — works on GitHub Pages. Exchange codes via chat or copy-paste.',
  ...
  nl: {
    ...
    enableMultiplayer: 'Multiplayer inschakelen (optioneel)',
      ...
      directP2PDesc: 'Speel met een vriend zonder server — werkt op GitHub Pages. Wissel codes uit via chat of kopieer-plak.',
  ...
  de: {
    ...
    enableMultiplayer: 'Mehrspieler aktivieren (optional)',
      ...
      directP2PDesc: 'Spiele mit einem Freund ohne Server — funktioniert auf GitHub Pages. Tausche Codes per Chat oder Kopieren-Einfügen aus.',
  ...
  es: {
    ...
    enableMultiplayer: 'Habilitar multijugador (opcional)',
      ...
      directP2PDesc: 'Juega con un amigo sin servidor — funciona en GitHub Pages. Intercambia códigos por chat o copia y pega.',
  ...
  fr: {
    ...
    enableMultiplayer: 'Activer le multijoueur (optionnel)',
      ...
      directP2PDesc: 'Jouez avec un ami sans serveur — fonctionne sur GitHub Pages. Échangez des codes par chat ou copier-coller.',
