...
describe('Social Share Functionality', () => {
  ...
  it('should generate appropriate share text for game over', () => {
    ...
    expect(shareText).toBe('Just played Side-Scrolling Platformer! 🎮 Final score: 1500 points on level 8! Can you beat it?');
  ...
  it('should generate appropriate share text for victory', () => {
    ...
    expect(shareText).toBe('Victory! 🏆 Just reached level 25 in Side-Scrolling Platformer with 5000 points! Amazing game!');
  ...
  it('should create share modal with all required elements', () => {
    ...
    shareText.textContent = 'Just played Side-Scrolling Platformer! 🎮 Final score: 1000 points on level 5! Can you beat it?';
    ...
    const platforms = ['Twitter', 'Facebook', 'LinkedIn', 'Reddit', 'Copy Link', 'Download'];
    ...
    const buttons = Array.from(buttonsContainer.children).map(btn => btn.textContent);
  ...
  it('should generate correct social media URLs', () => {
    const shareText = 'Just played Side-Scrolling Platformer! 🎮 Final score: 1500 points on level 8! Can you beat it?';
    ...
    expect(twitterUrl).toContain(encodeURIComponent('Side-Scrolling Platformer'));
    expect(twitterUrl).toContain(encodeURIComponent('github.com/commjoen/generated-game-experiment'));
    ...
    expect(facebookUrl).toContain(encodeURIComponent('github.com/commjoen/generated-game-experiment'));
